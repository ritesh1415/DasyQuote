...
/*$(document).ready(function(){
  ...
  $("#login_mobile, #user_mobile, #userMobile").intlTelInput({
      ...
      nationalMode: false,
      initialCountry: country_key,
      dropdownContainer: ".country-list"
  });
  
  var searchInput = $("<input>").attr("type", "text").attr("placeholder", "Search...");
  $(".country-list").prepend(searchInput);
  
  searchInput.on("input", function() {
      var query = this.value.toLowerCase();
      $(".country").each(function() {
          var countryName = $(this).attr("data-country-name").toLowerCase();
