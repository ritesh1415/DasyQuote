                                            ...
                                            <div class="booking-action">
                                                ...
                                                if ($blocked_user['status'] != 1) { //add new line?>
                                                    ...
                                                    <?php } ?>
                                                     ...
                                                     <?php if ($bookings['cod'] == 1 && ($bookings['status'] == 8)) {
                                                     ...
                                                     if ($bookings['cod'] != 1 && $bookings['status'] == 6 && empty($rating_count)) { ?>
                                                            <a href="javascript:void(0);" class="btn btn-sm bg-success-light myReview" data-toggle="modal" data-target="#myReview" data-id="<?php echo $bookings['id'] ?>" data-providerid="<?php echo $bookings['provider_id'] ?>" data-userid="<?php echo $bookings['user_id'] ?>" data-serviceid="<?php echo $bookings['service_id'] ?>"> 
                                                                <i class="fas fa-plus"></i> <?php echo (!empty($user_language[$user_selected]['lg_Reviews'])) ? $user_language[$user_selected]['lg_Reviews'] : $default_language['en']['lg_Reviews']; ?>
                                                            </a>
                                                    <?php
                            ...
                            <div class="table-responsive total-booking-report">
                                <table class="table table-hover table-center mb-0 service_table" >
                                    ...
                                    <?php foreach ($qanswers as $row): ?>
                                        <?php
                                                // $base_url = base_url() . "myquote_list/view_myquote" . $rows['id'];
                                                $base_url = base_url('myquote_list/view_myquote/'.$row->id);
                                                $action = "<a href='" . $base_url . "'' class='btn btn-sm bg-success-light mb-2 mr-2'><i class='far fa-edit mr-1'></i> View &nbsp; </a>"; 
                                            ?>
                                            <tr>
                                                <td> <?= $row->id ?></td>
                                                ...
                                                <td>DJ Pop</td>
                                                <!-- <td>'.$totalamount.'</td> -->
                                                <td><label class="badge badge-'.$color.'">Waiting</lable>
                                                </td>
                                                <td>Pending</td>
                                                <td> 
                                                <?=$action ?>
                                                <a href="<?php echo base_url('all_quotes/delete_quotes/'.$row->id); ?>" class="btn btn-sm bg-danger-light  delete_show" data-id=''><i class='far fa-trash-alt mr-1' ></i> Delete</a>


                                                </td>
                                                
                                                <td> <a href="<?php base_url()?>quote_reply" class="btn btn-primary text-white mt-3">View</a></td>
