				...
				<div class="widget settings-menu">
					<ul role="tablist" class="nav nav-tabs">	
						...
						<li class="nav-item current">
							...
							<a href="<?php echo base_url()?>myquote-list" class="nav-link <?= ($this->uri->segment(1)=="myquote-list")?'active':'';?>">
							<i class="fa fa-sticky-note" aria-hidden="true"></i>
								<span>
									My Quote List
									<!-- <?php echo (!empty($user_language[$user_selected]['lg_Booking_List'])) ? $user_language[$user_selected]['lg_Booking_List'] : $default_language['en']['lg_Booking_List']; ?> -->
								</span>
							</a>
						</li>
						...
						<li class="nav-item current">
							<a href="<?php echo base_url()?>user-bookings" class="nav-link <?= ($this->uri->segment(1)=="user-bookings")?'active':'';?>">
								...
								<span>
									<?php echo (!empty($user_language[$user_selected]['lg_Booking_List'])) ? $user_language[$user_selected]['lg_Booking_List'] : $default_language['en']['lg_Booking_List']; ?></span>
							</a>
						</li>
