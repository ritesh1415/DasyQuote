                                    ...
                                    <?php foreach ($qanswers as $row): ?>
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                <?=$action ?>
								               <a href="<?php echo base_url('all_quotes/delete_quotes/'.$row->user_id); ?>" class="btn btn-sm bg-danger-light delete_show" data-id=''><i class='far fa-trash-alt mr-1' ></i> Delete</a>
                                               <!-- <button type="hidden" >Quote Reply</button> -->
                                                </td>
