		...
		<div class="faq-card">
	        	...
	        	foreach ($pages as $key => $value) { ?>
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">
								<a class="collapsed" data-toggle="collapse" href="#faq<?php echo $i; ?>"><?php echo ($value->page_title)?$value->page_title:''; ?></a>
							</h4>
			...
			$i++;
		 			...
		 			<h3><?php echo (!empty($user_language[$user_selected]['lg_details_not_found'])) ? $user_language[$user_selected]['lg_details_not_found'] : $default_language['en']['lg_details_not_found']; ?> </h3>
		 		<?php } ?>				
		</div>
	</div>
</div>
