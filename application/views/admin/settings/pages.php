								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											...
											<input <?php echo $attr; ?> id="pages_status<?php echo $page->id ?>" class="check pages_status" data-id="<?php echo $page->id ?>" type="checkbox" <?php echo $val ?> <?php if($this->session->userdata('admin_id') != 1) { echo 'disabled'; } ?>>
