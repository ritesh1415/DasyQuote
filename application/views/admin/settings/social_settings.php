								...
								<div class="form-groupbtn">
									<ul>
										<?php if($this->session->userdata('admin_id') == 1) { ?>
											<li>	
												<button name="form_submit" type="submit" class="btn btn-update me-2" value="true">Update</button>
											</li>
										<?php } ?>
										<li>	
											<a href="<?php echo $base_url; ?>admin/social-settings"  class="btn btn-cancel">Cancel</a>
										</li>
									</ul>
								</div>
							</div>
