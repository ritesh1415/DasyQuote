                ...
                <div class="card">
                    <div class="card-body">
                        <form action="" id="lang_keywords_settings" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                <?php if ($user_role == 1) { ?>
                                    <button class="btn btn-primary " name="form_submit" value="submit" type="submit" value="true">Add Language</button>
                                <?php } ?>

                                <a href="<?php echo $base_url; ?>web-languages/<?php echo $this->uri->segment(2); ?>"  class="btn btn-cancel">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
