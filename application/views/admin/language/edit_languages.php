						...
						<form accept-charset="utf-8" id="language_settings" action="" method="POST" enctype="multipart/form-data">
							...
							<div class="mt-4">
								<?php if($this->session->userdata('role') == 1) { ?>
									<button name="form_submit" type="submit" class="btn btn-update me-2" value="true">Submit</button>
								<?php } ?>
								<a href="<?php echo $base_url; ?>languages"  class="btn btn-cancel">Cancel</a>
							</div>
						</form>
						<!-- Form -->
					</div>
