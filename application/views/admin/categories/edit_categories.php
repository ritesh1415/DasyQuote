                        ...
                        <form id="update_category" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
								<label>Is Featured?</label><br>
								 <label><input type="radio" name="is_featured" value="1" <?=(!empty($categories['is_featured'])&&$categories['is_featured']==1)?'checked':'';?>>Yes</label>
								 <label><input type="radio" name="is_featured" value="0" <?=($categories['is_featured']==0)?'checked':'';?>>No</label>
                            ...
                            <div class="mt-4">
								...
								<a href="<?php echo $base_url; ?>categories"  class="btn btn-cancel">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
