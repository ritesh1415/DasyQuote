...
class Statistical
{
    ...
    /* This function "MAX" that takes in any number of arguments and 

     *returns the largest numeric value among them. It loops through each argument,

     *checks if it is a numeric value, and if it is larger than the current maximum value. 

     *If it does not find any numeric values in the arguments list, it returns 0  

     @Created by yogesh : Jan 2023
     */
